...
// console.log(props.previousReservations)
// console.log(props.previousReservation)
// get current previous reservation of model being viewed
const pr = ref(props.previousReservations.find(reservation => reservation.id === props.previousReservation));
</script>
        ...
        <section class="flex flex-col gap-y-4 gap-x-8 sm:flex-row sm:justify-between w-full">
          <div class="flex flex-col gap-y-4 w-full">
            ...
            <div class="flex items-center gap-x-2">
              ...
              <p class="text-pretty"><strong>{{ pr.vehicle?.plate.toUpperCase() }}</strong> - {{ pr.vehicle?.brand }}
                {{ pr.vehicle?.model }}</p>
            </div>
          </div>
          <div class="flex flex-col gap-y-4 w-full">
...
<!--            <small class="text-pretty">{{ props.reasonForStatusChange || 'Sem pretexto.' }}</small>-->
          </div>
        </div>
      </div>
    </CardContent>
