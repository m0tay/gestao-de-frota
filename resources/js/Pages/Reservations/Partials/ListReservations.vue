                        ...
                        <div class="flex flex-col gap-y-4">
                            <section class="flex flex-col gap-y-4 gap-x-8 sm:flex-row sm:justify-between w-full">
                                <div class="w-full">
                                    ...
                                    <FakeDateTimeInput :date="(moment(reservation.start).toDate())" class="w-full" id="start"/>
                                </div>
                                <div class="w-full">
                                    <InputLabel value="Até:" for="end"/>
                                    <FakeDateTimeInput :date="(moment(reservation.end).toDate())" class="w-full" id="end"/>
                                </div>
                            </section>
                            <section class="flex flex-col gap-y-4 gap-x-8 sm:flex-row sm:justify-between w-full">
                                <div class="flex flex-col gap-y-4 w-full">
                                    ...
                                    <div class="flex items-stretch gap-x-2 bg-gray-50 text-muted-foreground px-3 py-2 rounded">
                                        ...
                                        <p class="text-pretty">{{ reservation.vehicle.plate.toUpperCase() }}<br>{{ reservation.vehicle.brand }} {{ reservation.vehicle.model }}</p>
                                    </div>
                                </div>
                                <div class="flex flex-col gap-y-4 w-full">
                                    <div
